            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-10 px-8 sm:px-16" style="border-radius: 53px; min-width: 500px; max-width: 650px">
                    <div class="text-center mb-5">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-2xl font-medium mb-2">Quên mật khẩu?</div>
                        <span class="text-muted-color font-medium text-sm">Nhập email để lấy lại mật khẩu tài khoản khách hàng</span>
                    </div>
                    ...
                    <div class="w-full max-w-xl mx-auto py-1">
                        ...
                        <form @submit.prevent="sendResetLink">
                            <div class="mb-4">
                                ...
                                <InputText id="email" type="email" placeholder="example@email.com" v-model="email" :class="{ 'p-invalid': submitted && !email }" class="w-full text-sm" />
                                <small v-if="submitted && !email" class="text-red-500 block mt-1">Email không được để trống</small>
                                <small v-if="submitted && email && !emailRegex.test(email)" class="text-red-500 block mt-1">Email không hợp lệ</small>
                            </div>

                            <Button type="submit" label="Gửi mã khôi phục" class="w-full mb-3" :loading="isSubmitting" />
                        </form>
