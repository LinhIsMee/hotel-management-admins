...
onMounted(() => {
    ...
    if (!token.value) {
        errorMessage.value = 'Token không hợp lệ hoặc đã hết hạn. Vui lòng thử lại.';
    }
});
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-10 px-8 sm:px-16" style="border-radius: 53px; min-width: 500px; max-width: 650px;">
                    <div class="text-center mb-5">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-2xl font-medium mb-2">Đặt lại mật khẩu</div>
                        <span class="text-muted-color font-medium text-sm">Tạo mật khẩu mới để tiếp tục trải nghiệm dịch vụ</span>
                    </div>
                    ...
                    <div class="w-full max-w-xl mx-auto py-1">
                        ...
                        <form @submit.prevent="resetPassword">
                            <div class="mb-3">
                                <label for="password" class="block text-surface-900 dark:text-surface-0 text-base font-medium mb-1">Mật khẩu mới</label>
                                <Password
                                    id="password"
                                    v-model="password"
                        ...
                        <div class="text-center mt-4">
                            <span class="text-surface-700 dark:text-surface-300 text-sm">Nhớ mật khẩu? </span>
                            <router-link to="/auth/login" class="font-medium text-primary text-sm hover:underline">Quay lại đăng nhập</router-link>
                        </div>
                    </div>
                </div>
            </div>
