...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            <router-link to="/" class="layout-topbar-logo">
                ...
                <span class="ml-2 text-xl font-bold"> <span class="text-amber-600">LUXURY</span><span class="text-slate-800">HOTEL</span> </span>
            </router-link>
        </div>
    ...
    <ul class="layout-topbar-menu hidden origin-top" v-bind:class="{ 'layout-topbar-menu-mobile-active': mobileMenuActive }">
        <li>
            <button class="p-link layout-topbar-button" @click="router.push('/admin/profile')">
